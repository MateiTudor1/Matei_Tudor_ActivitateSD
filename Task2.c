...
// Func?ie pentru citirea unui obiect de tipul Motor de la tastatur?
...
// Func?ie pentru calcularea mediei pre?urilor pieselor de pe un motor
...
// Func?ie pentru modificarea num?rului de piese de pe un motor
...
// Func?ie pentru afi?area informa?iilor despre un motor
...
// Func?ie pentru alocarea unui vector de motoare
struct Motor* aloca_vector_motoare(int dimensiune) {
    return (struct Motor*)malloc(dimensiune * sizeof(struct Motor));
}

// Func?ie pentru copierea obiectelor care îndeplinesc o anumit? condi?ie într-un nou vector
// Condi?ia este c? media pre?urilor pieselor s? fie mai mic? decât o anumit? valoare dat?
...
// Func?ie pentru mutarea obiectelor care îndeplinesc o anumit? condi?ie într-un nou vector
// Condi?ia este c? num?rul de piese s? fie mai mare decât o anumit? valoare dat?
...
// Func?ie pentru concatenarea a doi vectori de motoare
...
int main() {
    ...
    // Exemplu de copiere a motoarelor care au o medie a pre?urilor mai mic? decât 500 într-un alt vector
    ...
    // Exemplu de mutare a motoarelor care au un num?r de piese mai mare decât 5 într-un alt vector
    ...
    // Exemplu de concatenare a dou? vectori de motoare
